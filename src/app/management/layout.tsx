...
// /management lives outside the (frontend)/[locale] tree, so it
// needs its own <html>+<body> wrapper and its own globals.css
// import — otherwise Tailwind utility classes never load and the
// dashboard renders as unstyled HTML.
