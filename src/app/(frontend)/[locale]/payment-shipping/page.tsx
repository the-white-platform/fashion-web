    ...
    <div className="min-h-screen bg-background pt-32 text-foreground pb-12 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">Linh hoạt, an toàn và nhanh chóng</p>
        </motion.div>
        ...
        <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-card border-2 border-border rounded-sm p-6">
                ...
                <div className="space-y-3 text-muted-foreground">
                  ...
                  <div className="bg-muted border border-border rounded-sm p-3 text-sm">
          ...
          >
            <div className="bg-foreground text-background border-2 border-foreground rounded-sm p-8 mb-8">
              ...
              <p className="opacity-80">Giao hàng toàn quốc với đối tác vận chuyển uy tín</p>
            </div>
