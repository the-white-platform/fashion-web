...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen pt-32 bg-white text-black pb-12 relative">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-white text-black py-6 rounded-sm border-2 border-black hover:bg-black hover:text-white transition-all hover:scale-[1.02] uppercase tracking-[0.2em] font-bold text-xs flex items-center justify-center gap-3"
                >
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button className="border-2 border-gray-200 py-4 rounded-sm hover:border-black transition-all hover:scale-[1.02] flex items-center justify-center gap-2 uppercase tracking-[0.1em] font-bold text-[10px]">
              ...
              <div className="pt-10 border-t border-gray-100 dark:border-gray-800 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className="w-12 h-12 bg-gray-50 flex items-center justify-center mb-1 transition-colors group-hover:bg-black">
                  ...
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className="w-12 h-12 bg-gray-50 flex items-center justify-center mb-1">
