...
* **management:** move routes out of route group so /management actually exists ([db56c22](https://github.com/the-white-platform/fashion-web/commit/db56c2288a379f6e8d671c93601642bfc436f131))

### [0.63.1](https://github.com/the-white-platform/fashion-web/compare/v0.63.0...v0.63.1) (2026-04-23)


### Bug Fixes

* **management,nav:** toaster mount + force-dynamic on each page ([8253dd5](https://github.com/the-white-platform/fashion-web/commit/8253dd5b34277f4d0a0ee953255fdbab350b5c3d))
...
* **proxy:** exclude /management from next-intl locale prefixing ([c475e33](https://github.com/the-white-platform/fashion-web/commit/c475e331fc39b3bacbc059130dfd9dfdb096969f))

### [0.62.2](https://github.com/the-white-platform/fashion-web/compare/v0.62.1...v0.62.2) (2026-04-23)


### Bug Fixes

* **zns-logs:** add missing payload_locked_documents_rels FK column ([dd44583](https://github.com/the-white-platform/fashion-web/commit/dd445836ca300ca4c5e611387de57dd06ec46cbf))
...
* **admin-zalo:** zero-pad dates + require phone + auto-fill override ([d100630](https://github.com/the-white-platform/fashion-web/commit/d100630323f08c48a42b573f5302a5960b1fe634))
...
* **zalo:** ZNS lives on business.openapi.zalo.me, not the OA host ([687ad7c](https://github.com/the-white-platform/fashion-web/commit/687ad7c624e1a6c5f84deb15282d7ce2735bcd39))
...
* **admin:** paginate Zalo sender user picker + fix missing i18n ([47e6375](https://github.com/the-white-platform/fashion-web/commit/47e6375aa323dee4710703ae95bc5ca0a1eda221))

### [0.60.2](https://github.com/the-white-platform/fashion-web/compare/v0.60.1...v0.60.2) (2026-04-23)


### Bug Fixes

* **migrations:** drop functional birthday index — not IMMUTABLE on timestamptz ([244f5bd](https://github.com/the-white-platform/fashion-web/commit/244f5bdd352378a3329cb2bb16fe0f13c69ed2ee))

### [0.60.1](https://github.com/the-white-platform/fashion-web/compare/v0.60.0...v0.60.1) (2026-04-23)


### Bug Fixes

* **feed:** force-dynamic on /products-feed.xml to unblock Docker build ([ecf7f2b](https://github.com/the-white-platform/fashion-web/commit/ecf7f2bd19a8247a39719cbb2d9b1b997140f480))
...
* **vto:** open full-size image via blob URL, not data: URL ([bd4430b](https://github.com/the-white-platform/fashion-web/commit/bd4430bb587b09c9f60bf0f30e3cc6b0b3e2b9a6))

## [0.58.0](https://github.com/the-white-platform/fashion-web/compare/v0.57.0...v0.58.0) (2026-04-23)


### Features

* **zalo:** admin test ZNS button + fix Zalo login session persistence ([db67c3a](https://github.com/the-white-platform/fashion-web/commit/db67c3a2783d160907bd3dc963476803f167dab5))
